...
export default function Home() {
  return (
    <>
      ...
      <GridWrapper width="100vw" height="100vh" margin="40px 60px">
          ...
          <LinkButton href="#" rel="noreferrer" target="_blank">GitHub</LinkButton>
          <LinkButton href="#" rel="noreferrer" target="_blank">Code Pen</LinkButton>
          </FlexWrapper>
          <CubeScene/>
      </GridWrapper>
