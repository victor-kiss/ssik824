  ...
  return (
    <html lang="pt-br">
      ...
      <header>
        ...
        </svg> e <a href="https://nextjs.org/" rel="noreferrer" target="_blank" >Next.js. </a> <br> Ilustrações feitas por <a href="https://storyset.com/" rel="noreferrer" target="_blank"> Story Set <a></span>
        </footer>
      </body>
    </html>
  )
